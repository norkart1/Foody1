...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (e.code === "auth/operation-not-allowed") setError("Email sign-up not enabled in Firebase Console.");
      ...
      else setError(e.code || e.message || "Registration failed.");
      ...
      <div className="w-full max-w-sm bg-white flex flex-col min-h-screen sm:min-h-0 sm:rounded-2xl sm:shadow-md px-6 pt-12 pb-8">
        ...
        <form onSubmit={handleRegister} noValidate>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-green-500 hover:bg-green-600 active:bg-green-700 text-white font-semibold py-4 rounded-full transition-colors disabled:opacity-60 text-sm mb-6"
          >
